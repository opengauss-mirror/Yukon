...
INSERT INTO public.topology (id,name,srid,precision,hasz)
  VALUES(1,'test',10,20,'f');
SELECT E'--registered_topo--\n' || TopologySummary('test');
INSERT INTO public.layer (topology_id,layer_id, schema_name, table_name, feature_column, feature_type, level, child_id)
...
DELETE FROM public.layer WHERE topology_id = 1;
DELETE FROM public.topology WHERE id = 1;
