...
SELECT public.ST_ModEdgeHeal('city_data', 1, null);
SELECT public.ST_ModEdgeHeal('city_data', null, 1);
SELECT public.ST_ModEdgeHeal(null, 1, 2);
SELECT public.ST_ModEdgeHeal('', 1, 2);

-- Not connected edges
SELECT public.ST_ModEdgeHeal('city_data', 25, 3);

-- Other connected edges
SELECT public.ST_ModEdgeHeal('city_data', 9, 10);

-- Closed edge
SELECT public.ST_ModEdgeHeal('city_data', 2, 3);
SELECT public.ST_ModEdgeHeal('city_data', 3, 2);

-- Heal to self
SELECT public.ST_ModEdgeHeal('city_data', 25, 25);
...
SELECT 'MH(4,5)', public.ST_ModEdgeHeal('city_data', 4, 5);

-- Face and other edges involved, SQL/MM caseno 1, drops node 16
SELECT 'MH(21,6)', public.ST_ModEdgeHeal('city_data', 21, 6);
-- Face and other edges involved, SQL/MM caseno 2, drops node 19
SELECT 'MH(8,15)', public.ST_ModEdgeHeal('city_data', 8, 15);
-- Face and other edges involved, SQL/MM caseno 3, drops node 8
SELECT 'MH(12,22)', public.ST_ModEdgeHeal('city_data', 12, 22);
-- Face and other edges involved, SQL/MM caseno 4, drops node 11
SELECT 'MH(16,14)', public.ST_ModEdgeHeal('city_data', 16, 14);
...
SELECT public.ST_ModEdgeHeal('t', 1, 2);
SELECT public.ST_ModEdgeHeal('t', 2, 1);
...
SELECT public.ST_ModEdgeHeal('t', 1, 200);
SELECT public.ST_ModEdgeHeal('t', 100, 2);
...
-- 'F+E3-E4' and 'F-E3+E4'
SELECT 'tg-update', 'MH(3,4)', public.ST_ModEdgeHeal('t', 3, 4);
...
SELECT '#942', public.ST_ModEdgeHeal('t', 1, 3);
...
SELECT '#1955.1', 'H:1,2', 'N' || public.ST_ModEdgeHeal('t', 1, 2), 'deleted';

SELECT '#1955.1', count(node_id), 'nodes left' as label FROM t.node GROUP BY label;

SELECT '#1955.2', 'E'||public.AddEdge('t', 'LINESTRING(50 0, 60 0, 60 10)');        -- 3
SELECT '#1955.2', 'E'||public.AddEdge('t', 'LINESTRING(50 0, 50 10, 60 10)'); ;     -- 4
SELECT '#1955.2', 'E'||public.AddEdge('t', 'LINESTRING(60 10, 70 10)'); ;           -- 5
...
-- another edge
SELECT '#1955.2', 'H:3,4', 'N' || public.ST_ModEdgeHeal('t', 3, 4), 'deleted';

SELECT '#1955.2', count(node_id), 'nodes left' as label FROM t.node GROUP BY label;

SELECT '#1955.3', 'E'||public.AddEdge('t', 'LINESTRING(80 0, 90 0, 90 10)');        -- 6
SELECT '#1955.3', 'E'||public.AddEdge('t', 'LINESTRING(80 0, 80 10, 90 10)'); ;     -- 7
SELECT '#1955.3', 'E'||public.AddEdge('t', 'LINESTRING(70 10, 80 0)'); ;            -- 8
...
-- another edge
SELECT '#1955.3', 'H:6,7', 'N' || public.ST_ModEdgeHeal('t', 6, 7), 'deleted';
