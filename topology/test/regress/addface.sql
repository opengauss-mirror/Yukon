...
SELECT 'f*',  public.addFace('tt', 'POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))');
...
SELECT 'f1',  public.addFace('tt', 'POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))');

-- Register the _same_ face  again
SELECT 'f1*',  public.addFace('tt', 'POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))');

-- Register a face with no holes matching all edges in the same direction
SELECT 'f2',  public.addFace('tt', 'POLYGON((10 10, 20 10, 20 0, 10 0, 10 10))');
...
SELECT 'f1-force',  public.addFace('tt', 'POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))', true);
...
SELECT 'MiX-e1',  public.addEdge('Ul', 'LINESTRING(0 0, 10 0)');
SELECT 'MiX-e2',  public.addEdge('Ul', 'LINESTRING(10 0, 10 10)');
SELECT 'MiX-e3',  public.addEdge('Ul', 'LINESTRING(0 10, 10 10)');
SELECT 'MiX-e4',  public.addEdge('Ul', 'LINESTRING(0 0, 0 10)');
SELECT 'MiX-f1',  public.addFace('Ul', 'POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))');
SELECT public.DropTopology('Ul');

-- Test polygons with holes
SELECT public.CreateTopology('t2') > 0;

-- Edges forming two squares
SELECT 't2.e1',  public.addEdge('t2', 'LINESTRING(0 0, 10 0)');
SELECT 't2.e2',  public.addEdge('t2', 'LINESTRING(10 0, 10 10)');
SELECT 't2.e3',  public.addEdge('t2', 'LINESTRING(0 10, 10 10)');
SELECT 't2.e4',  public.addEdge('t2', 'LINESTRING(0 0, 0 10)');
SELECT 't2.e5',  public.addEdge('t2', 'LINESTRING(10 10, 20 10)');
SELECT 't2.e6',  public.addEdge('t2', 'LINESTRING(20 10, 20 0)');
SELECT 't2.e7',  public.addEdge('t2', 'LINESTRING(20 0, 10 0)');

-- Clockwise hole within the square on the left
SELECT 't2.e8',  public.addEdge('t2', 'LINESTRING(1 1, 1 2, 2 2, 2 1, 1 1)');
-- Counter-clockwise hole within the square on the left
SELECT 't2.e9',  public.addEdge('t2', 'LINESTRING(3 1,4 1,4 2,3 2,3 1)');

-- Multi-edge hole within the square on the right
SELECT 't2.e10',  public.addEdge('t2', 'LINESTRING(12 2, 14 2, 14 4)');
SELECT 't2.e11',  public.addEdge('t2', 'LINESTRING(12 2, 12 4, 14 4)');

-- Register left face with two holes
SELECT 't2.f1',  public.addFace('t2',
...
--   N1 +-------'
--
SELECT public.CreateTopology('t3') > 0;

SELECT 't3.e1',  public.addEdge('t3', 'LINESTRING(0 0, 0 10)');
SELECT 't3.e2',  public.addEdge('t3', 'LINESTRING(0 10, 5 5, 0 0)');
SELECT 't3.e3',  public.addEdge('t3', 'LINESTRING(0 10, 10 10, 10 0, 0 0)');

-- Register F1
SELECT 't3.f1',  public.addFace('t3',
'POLYGON((5 5, 0 10, 10 10, 10 0, 0 0, 5 5))');

-- Register F2
SELECT 't3.f2',  public.addFace('t3', 'POLYGON((0 0, 5 5, 0 10, 0 0))');
...
-- and nodes
--
SELECT public.CreateTopology('t4') > 0;

SELECT 'N' || public.addNode('t4', 'POINT(2 6)');
UPDATE t4.node set containing_face = 0 WHERE node_id = 1;

SELECT 'E' || public.addEdge('t4', 'LINESTRING(0 0,10 0)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(10 0,10 10)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(10 10,0 10)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(0 0,0 10)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(0 0,5 5)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(5 5,6 5)');
SELECT 'E' || public.addEdge('t4', 'LINESTRING(0 10,8 8,10 0)');

select 'F' || public.addface('t4','POLYGON((0 0, 0 10, 10 10, 10 0, 0 0))');
...
SELECT public.DropTopology('t4');

--
-- Test narrow face. See ticket #1302.
-- {
--
SELECT '#1302', public.CreateTopology('tt') > 0;

SELECT '#1302', 'E' || public.addEdge('tt', '01020000000300000000917E9BA468294100917E9B8AEA2841C976BE1FA4682941C976BE9F8AEA2841B39ABE1FA46829415ACCC29F8AEA2841');
SELECT '#1302', 'E' || public.addEdge('tt', '010200000003000000B39ABE1FA46829415ACCC29F8AEA284137894120A4682941C976BE9F8AEA284100917E9BA468294100917E9B8AEA2841');
SELECT '#1302', 'F' || public.addFace('tt', '0103000000010000000500000000917E9BA468294100917E9B8AEA2841C976BE1FA4682941C976BE9F8AEA2841B39ABE1FA46829415ACCC29F8AEA284137894120A4682941C976BE9F8AEA284100917E9BA468294100917E9B8AEA2841');

SELECT '#1302', 'E' || edge_id, 'L' || left_face, 'R' || right_face FROM tt.edge_data ORDER BY edge_id;

SELECT '#1302', public.DropTopology('tt');
-- }
