...
SELECT public.ST_AddEdgeModFace('city_data', 7, 6,
 'LINESTRING(36 38,57 33)');
SELECT public.ST_AddEdgeModFace('city_data', 5, 7,
 'LINESTRING(36 38,57 33)');
...
-- Crosses a node
SELECT public.ST_AddEdgeModFace('city_data', 5, 6,
 'LINESTRING(36 38, 41 40, 57 33)');

-- Non-existent node
SELECT public.ST_AddEdgeModFace('city_data', 5, 60000,
 'LINESTRING(36 38,57 33)');
SELECT public.ST_AddEdgeModFace('city_data', 60000, 6,
 'LINESTRING(36 38,57 33)');
...
-- Coincident edge
SELECT public.ST_AddEdgeModFace('city_data', 18, 19,
...
SELECT 'O', public.ST_AddEdgeModFace('city_data', 5, 6,
...
--    inward edge on the right face
--
SELECT 1 as id, public.st_addedgemodface('city_data', 14, 18,
...
--    outward edge on the right face
--
INSERT INTO newedge SELECT 2, public.st_addedgemodface('city_data',
...
--    outward edge on the right face
--
INSERT INTO newedge SELECT 3, public.st_addedgemodface('city_data',
...
--    inward edge on the right face
--
INSERT INTO newedge SELECT 4, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 5, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 6, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 7, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 8, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 9, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 10, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 11, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 12, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 13, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 14, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 15, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 16, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 17, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 18, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 19, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 20, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 21, public.st_addedgemodface('city_data',
...
--
SELECT 'T22-', 'N' || public.st_addisonode('city_data', 23, 'POINT(26 36)'), 23;
SELECT 'T22-', 'N' || public.st_addisonode('city_data', 23, 'POINT(26 34.5)'), 23;
SELECT 'T22-', 'N' || public.st_addisonode('city_data', 23, 'POINT(26 33)'), 23;
INSERT INTO newedge SELECT 22, public.st_addedgemodface('city_data',
...
-- Faces on both sides contain isolated nodes.
--
INSERT INTO newedge SELECT 23, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 24, public.st_addedgemodface('city_data',
...
-- All involved faces contain isolated nodes
--
INSERT INTO newedge SELECT 25, public.st_addedgemodface('city_data',
...
--
INSERT INTO newedge SELECT 26, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 27, public.st_addedgemodface('city_data',
...
INSERT INTO newedge SELECT 28, public.st_addedgemodface('city_data',
...
INSERT INTO city_data.fp VALUES ('F17',
  public.CreateTopoGeom('city_data', 3, 1, '{{17,3}}'));
