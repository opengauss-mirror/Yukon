...
-- Original submission
SELECT 't1855_0.start', public.CreateTopology('bug1855', 0, 0.00001) > 0;
SELECT 't1855_0.0', public.TopoGeo_addPolygon('bug1855',
        'POLYGON((76.26727 9.85751,76.29001 9.90026,
                  76.29942 9.86257,76.26727 9.85751))'
::geometry);
SELECT 't1855_0.1', public.TopoGeo_addPolygon('bug1855',
...
::geometry);
SELECT 't1855_0.end', public.DropTopology('bug1855');

-- See https://trac.osgeo.org/postgis/ticket/1946
SELECT 't1946.start', public.CreateTopology('bug1946', 0, 0.00001) > 0;
SELECT 't1946.0', public.topogeo_AddPolygon('bug1946',
'POLYGON((76.68554 30.74,76.68726 30.74248,
          76.69223 30.74157,76.68554 30.74))'
::geometry);
SELECT 't1946.1', public.topogeo_AddPolygon('bug1946',
...
/**SELECT 't1946.2', public.topogeo_AddPolygon('bug1946',
...
SELECT 't1946.2', COUNT(*) 
  FROM public.topogeo_AddPolygon('bug1946',
'POLYGON((76.68728 30.74248,76.68727 30.74248,
          76.68727 30.74249,76.67933 30.75,
          76.69223 30.74157,76.68728 30.74248))'
::geometry); 

SELECT 't1946.end', public.DropTopology('bug1946');
