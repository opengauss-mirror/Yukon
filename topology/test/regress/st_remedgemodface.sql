...
-- Bogus calls -- {
SELECT public.ST_RemEdgeModFace('city_data', null);
SELECT public.ST_RemEdgeModFace(null, 1);
SELECT public.ST_RemEdgeModFace('', 1);
SELECT public.ST_RemEdgeModFace('city_data', 0); -- non-existent
SELECT public.ST_RemEdgeModFace('city_data', 143); -- non-existent
...
SELECT 'RM(25)', public.ST_RemEdgeModFace('city_data', 25);
...
SELECT 'RM(4)', public.ST_RemEdgeModFace('city_data', 4);
...
SELECT 'RM(26)', public.ST_RemEdgeModFace('city_data', 26);
...
SELECT 'RM(9)', public.ST_RemEdgeModFace('city_data', 9);
...
-- New face has a mbr being the union of the dropped faces
SELECT 'RM(19)', public.ST_RemEdgeModFace('city_data', 19);
...
SELECT 'RM(10)', public.ST_RemEdgeModFace('city_data', 10);
...
SELECT 'RM(20)', public.ST_RemEdgeModFace('city_data', 20);
...
SELECT 'RM(15)', public.ST_RemEdgeModFace('city_data', 15);
...
SELECT 'RM(2)', public.ST_RemEdgeModFace('city_data', 2);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(27)', public.ST_RemEdgeModFace('city_data', 27);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(28)', public.ST_RemEdgeModFace('city_data', 28);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(29)', public.ST_RemEdgeModFace('city_data', 29);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(31)', public.ST_RemEdgeModFace('city_data', 31);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(32)', public.ST_RemEdgeModFace('city_data', 32);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(33)', public.ST_RemEdgeModFace('city_data', 33);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(34)', public.ST_RemEdgeModFace('city_data', 34);
...
SELECT save_edges(); SELECT save_faces(); SELECT save_nodes();
-- Here's the removal
SELECT 'RM(35)', public.ST_RemEdgeModFace('city_data', 35);
...
SELECT '*RM(3)', public.ST_RemEdgeModFace('city_data', 3);
-- A city_street is defined by edge 4 and 5, can't drop any of the two
SELECT '*RM(4)', public.ST_RemEdgeModFace('city_data', 4);
SELECT '*RM(5)', public.ST_RemEdgeModFace('city_data', 5);
...
SELECT '*RM(17)', catch_error($$SELECT public.ST_RemEdgeModFace('city_data', 17)$$);
...
SELECT 'RM(11)', public.ST_RemEdgeModFace('city_data', 11);
...
SELECT '*RM(8)', public.ST_RemEdgeModFace('city_data', 8); -- face_right=8
SELECT '*RM(15)', public.ST_RemEdgeModFace('city_data', 15); -- face_left=8
