...
SELECT NULL FROM public.AddTopoGeometryColumn('city_data', 'features',
...
INSERT INTO features.big_parcels(feature_name, feature) VALUES ('P1P2', -- Feature name
  public.CreateTopoGeom(
    ...
    (SELECT layer_id FROM public.layer WHERE table_name = 'big_parcels'),
    '{{1,1},{2,1}}')); -- P1 and P2
...
INSERT INTO features.big_streets(feature_name, feature)VALUES ('R1R2', -- Feature name
  public.CreateTopoGeom(
    ...
    (SELECT layer_id FROM public.layer WHERE table_name = 'big_streets'),
...
INSERT INTO features.big_signs(feature_name, feature) VALUES ('S1S2', -- Feature name
  public.CreateTopoGeom(
    ...
    (SELECT layer_id FROM public.layer WHERE table_name = 'big_signs'),
    '{{1,2},{2,2}}')); -- S1 and S2
